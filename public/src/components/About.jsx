  ...
  return (
    <div className="section" id="about">
      ...
      <ul>
        ...
        <li>Experienced in React for creating dynamic user interfaces</li>
        <li>Strong knowledge of SQL databases and CRUD operations</li>
        <li>Skilled in JavaScript, Tailwind CSS, and traditional HTML & CSS</li>
        <li>Capable of developing full-stack web applications</li>
      </ul>
      <h3>Personal Interests</h3>
      <p>Beyond coding, I am passionate about staying updated with the latest tech news, enjoying movies, and maintaining a healthy lifestyle through regular gym workouts.</p>
    </div>
  );
}
